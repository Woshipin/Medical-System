...
export default function DepartmentsPage() {
  ...
  const filteredDepartments = useMemo(() => {
    return departments.filter((dept) => {
      ...
      const matchStatus = statusFilter === "all" || dept.isActive.toString() === statusFilter;
  ...
  const openEditModal = (dept: Department) => {
    setModalMode("edit");
    setErrors({});
    setFormData({ id: dept.id, name: dept.name, location: dept.location, isActive: dept.isActive });
    setIsModalOpen(true);
  };
            ...
            <div className="p-6 space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select name="isActive" value={formData.isActive} onChange={handleInputChange} className="appearance-none w-full pl-10 pr-3 py-2.5 text-sm border border-slate-300 rounded-lg bg-white text-slate-900 outline-none focus:ring-2 focus:ring-emerald-500 cursor-pointer">
            ...
            <div className="p-6 bg-slate-50">
              <div className="grid grid-cols-1 gap-4">
                {[
                  ...
                  { label: "Status", value: viewData.isActive ? "Active" : "Inactive", icon: Activity, isBadge: true, variant: viewData.isActive ? "success" : "danger" },
                ].map((item, idx) => (
